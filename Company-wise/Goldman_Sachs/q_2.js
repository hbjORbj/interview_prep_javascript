...
/*
The substring starting with the largest character is the answer. Hence we advance j and try to find the 
biggest character while we use i to keep track of the current maximum string.
...
- (1) the substring with bigger next character is the answer. (2) if the shorter substring is exactly the same to the longer substring up to its end, the longer substring is the answer.

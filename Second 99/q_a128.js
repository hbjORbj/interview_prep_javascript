...
function maxInserts(S) {
    ...
    for (let i = 0; i < S.length; i++) {
        ...
        if (substr.length >= 3) return -1; // 3 or greater consecutive a's exist
    }
...
/*
1. Keep track of possible substrings of consecutive a's in order to figure out if there is already
a substring of a's of length greater than or equal to 3. If so, return -1. Else, continue scanning through the array.
